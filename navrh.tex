...
Je tvořena drobnou kostrou napsanou v HTML, která je masivně rozšířená \pojem[JavaScriptovým]{JavaScript}{formálně ECMAScript, interpretovaný jazyk běžící v internetovém prohlížeči, který umožňuje tvůrci webové stránky interaktivně manipulovat s jejím obsahem} frameworkem, který zajišťuje dynamičnost a interaktivitu celé stránky.
