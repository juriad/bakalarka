...
Synchronizaci záložek umožňují také různé služby, které nabízejí doplňky do prohlížečů, některé z nich fungují dokonce nezávisle na konkrétním prohlížeči, nicméně je třeba je mít nainstalované, jinak pohodlí použivání těchto služeb dramaticky klesá. % TODO delicious
...
Skrze tato tlačítka je možné odeslat články do některé z rozšířenějších služeb; často je jejich seznam omezený na facebook, twitter a google plus. % TODO linky
...
Nároky, které na něj uživatel má, jsme již uvedli v kapitole. % TODO link
