...
Na tomto místě popíšeme manipulaci s entitami, ke které dochází v samotné aplikaci.
Z popsaných procesů je zřejmé, jak jsou jednotlivé požadavky na aplikaci realizovány.
