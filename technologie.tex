...
Knihovna \href{http://jsoup.org/}{jsoup} umožňuje rozparsovat HTML stránku do \zkratka{DOM}{Document Object Model -- popisuje obsah HTML nebo XML dokumentů pomocí stromové struktury elementů; specifikace~\cite{Isaacson:1998} definuje i metody pro přístup k elementům a manipulaci} struktury.
...
\begin{itemize}
	\item kompilátor z Javy do \zkratka[JavaScriptu]{JavaScript}{formálně ECMAScript, interpretovaný jazyk běžící v internetovém prohlížeči, který umožňuje tvůrci webové stránky interaktivně manipulovat s jejím obsahem},
